...
public class ProductBestSellerListPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ProductBestSellerListPanel() throws Exception {
		...
		scrollPane.setViewportView(productBestSellerListPanel);
		productBestSellerListPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
		...
		productBestSellerListPanel.add(bestSellerListPanel);

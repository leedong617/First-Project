...
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '세이노의가르침', 6480, 'selfImprovement1.jpg', '순자산 천억원대 자산가의 인생이야기',20);
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '최적의공부뇌', 15120, 'selfImprovement2.jpg', '공부를 잘하기 위한 최소조건인 뇌의최적화에 대해',20);
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '역행자 확장판', 17550, 'selfImprovement3.jpg', '운명과 본능의 지배에서 벗어나 경제적 자유와 행복을 쟁취하는 라이프해킹의 비밀을 담은 책',20);
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '사장학개론', 22500, 'selfImprovement4.jpg', '한국과 미국, 전 세계를 오가며 ‘사장을 가르치는 사장’으로 알려진 『돈의 속성』의 저자 김승호 회장의 신간',20);
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '꿀벌의예언1', 15120, 'novel1.jpg', '꿀벌이 사라진 지구를 예언서로 구하는 이야기',30);
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '있을법한모든것', 13500, 'novel2.jpg', '우리도한번쯤상상해봤을또는 상상하지못한 이야기',30);
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '꿀벌의예언2', 15120, 'novel3.jpg', '꿀벌이 사라진 지구를 예언서로 구하는 이야기',30);
insert into product(p_no,p_name,p_price,p_image,p_desc,p_category) values(product_p_no_SEQ.nextval, '나니아 연대기 (리커버 특별판)', 67500, 'novel4.jpg', '나니아 연대기 시리즈 총 7편을 하나로 묶은 합본의 특별판',30);
